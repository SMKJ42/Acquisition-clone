...
const Courses: NextPageWithLayout = () => {
  useEffect(() => {
    ...
    script.src = "https://fast.wistia.com/embed/medias/d1svkqdoel.jsonp";
    script.async = true;
    ...
    <div className="mt-8">
      <div className="grid grid-cols-12">
        <div className="col-span-12 flex flex-col items-center md:col-span-9">
          <h1 className="text-center text-4xl font-bold">BONUS CREATION </h1>
        ...
        <div className="col-span-12 mb-8 w-full md:col-span-9 md:px-8">
          ...
          <div className="wistia_embed wistia_async_d1svkqdoel videoFoam=true  h-full w-full ">
            {/* Video sits in here */}
          </div>
          {/* </div> */}
        </div>
